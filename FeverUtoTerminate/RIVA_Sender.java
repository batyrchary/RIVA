...
public class RIVA_Sender
{
    ...
    public RIVA_Sender(String host, int port)
    {
        try {
    ...
    public void sendFile(String path) throws IOException
    {
        ...
        while (true)
        {
            ...
            //new added
            CacheEvictRunnable cacheEvictRunnable = new CacheEvictRunnable(currentFile);
    ...
    public static void main(String[] args) {
        ...
        RIVA_Sender fc = new RIVA_Sender(destIp, 2008);
        try {
            fc.sendFile(path);
        } catch (IOException e) {
            e.printStackTrace();
    ...
    {
        RIVA_Sender.FiverFile fiverFile;
        public CacheEvictRunnable(RIVA_Sender.FiverFile fiverFile) {
